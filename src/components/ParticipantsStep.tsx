...
import { responseMatchKey } from "../lib/matching";
...
interface ParticipantsStepProps {
  ...
  onSelectionChange: (ids: Set<string>) => void; onManualMatch: (responseKey: string, rosterIndex: number | null) => void;
